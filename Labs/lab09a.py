...
def build_map( in_file1, in_file2 ):
    ...
    for line in in_file1:
        ...
        if continent != "":
            ...
            main_map_dict[continent] = {}
            if continent not in main_map_dict:
                if country != '':
                    if country not in main_map_dict[continent]:
                        main_map_dict[continent] = {country: []}
        ...
        if country != "":
            ...
            for continent in data_map:
                if country in data_map[continent]:
                    main_map_dict[continent][country].append(city)
    return data_map
